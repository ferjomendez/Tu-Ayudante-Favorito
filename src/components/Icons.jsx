// Set único de íconos inline (trazo estilo feather) para no depender de
// imágenes ni librerías externas.
const PATHS = {
  video: (
    <>
  ...
  circuit: (
    <>
      ...
      <path d="M7 12h6m0 0V6h4m-4 6v6h4" />
    </>
  ),
  play: (
    <>
  ...
  layers: (
    <>
      ...
      <path d="m2 17.5 10 5.5 10-5.5" transform="translate(0 -1)" />
    </>
  ),
  mesh: (
    <>
